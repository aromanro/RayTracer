...
protected:
	...
	void BuildMaterialsAndNormalsMaps(std::map<std::string, std::shared_ptr<Materials::Material>>& materialsMap, std::map<std::string, std::shared_ptr<Textures::Texture>>& normalsMap, const std::string& dir);
